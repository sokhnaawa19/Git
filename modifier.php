    ...
    <div class="main-block">
      ...
      <form method="post">
        <div class="title">
          ...
          <h2>Modification des infos d'un livre</h2>
        </div>
        <div class="info">
          <input class="bookid" type="text" name="bookid" value="<?php echo $bookid; ?>" readonly="readonly">
          <input type="text" name="isbn" value="<?php echo $isbn; ?>">
          <input type="text" name="pubdate" value="<?php echo $pubdate; ?>">
          <input type="text" name="title" value="<?php echo $title; ?>" >
          <input type="text" name="categorie" value="<?php echo $categorie; ?>" >
        </div>
       
        <button type="submit" name="submit" href="/">Modifier</button>
      </form>
    </div>
  </body>
</html>