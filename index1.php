...
<thead>
        ...
        <th data-field="nomclient">Nom</th>
        <th data-field="prenomclient" data-sortable="true">Prénom</th>
        ...
        <th data-field="dureeCompte" data-sortable="true">Durée de validité</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td> <?php echo $client->dureeCompte; ?> </td>
...
<div class="fixed-plugin" style="top: 300px">
  ...
  <script type="text/javascript">
    ...
    function operateFormatter(value, row, index) {
      return [
        '<a href="modifier1.php?id=<?php echo $book['id']; ?>" title="Edit">',
